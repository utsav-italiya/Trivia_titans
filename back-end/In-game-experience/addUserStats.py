...
def insert_user_stats(request):
    ...
    if request_json and 'user_id' in request_json and 'team_name' in request_json and 'game_id' in request_json:
        ...
        try:
            ...
            response = {'success': True, 'message': 'User successfully inserted'}
            status_code = 200
        ...
        response = {'success': False, 'message': 'Invalid request: Missing user_id, team_name or game_id'}
        headers = {'Access-Control-Allow-Origin': '*'}
